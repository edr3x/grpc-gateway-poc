...
type AuthServiceClient interface {
	...
	Profile(ctx context.Context, in *NoRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *authServiceClient) Profile(ctx context.Context, in *NoRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/auth_service.AuthService/Profile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	Profile(context.Context, *NoRequest) (*User, error)
...
func (UnimplementedAuthServiceServer) Profile(context.Context, *NoRequest) (*User, error) {
...
func _AuthService_Profile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth_service.AuthService/Profile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Profile(ctx, req.(*NoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
